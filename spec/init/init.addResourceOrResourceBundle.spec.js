  ...
  describe('bundles', function() {
    ...
    describe('with a additional namespace', function() {
      ...
      beforeEach(function(done) {
        i18n.init(i18n.functions.extend(opts, { resStore: resStore }),
          function(t) {
            i18n.addResourceBundle('en-US', 'newNamespace', { 'simple_en-US': 'ok_from_newNamespace_en-US' });
            done();
          });
      });

      it('it should add the new namespace to the namespace array', function() {
        expect(i18n.t('newNamespace:simple_en-US')).to.equal('ok_from_newNamespace_en-US');
      });
